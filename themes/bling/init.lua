...
return function(theme)
  ...
  theme.window_switcher_widget_bg = "#000000A0" -- The bg color of the widget
  ...
  theme.window_switcher_widget_border_color = "#000000" -- The border color of the widget
  ...
  theme.window_switcher_name_normal_color = "#A0A0A0" -- The color of one title if the client is unfocused
  theme.window_switcher_name_focus_color = "#ffffff" -- The color of one title if the client is focused
  theme.window_switcher_icon_valign = "center" -- How to vertically align the one icon
  theme.window_switcher_icon_width = 30
