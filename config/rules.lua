...
ruled.client.connect_signal('request::rules', function()
    ...
    ruled.client.append_rule {
        ...
        rule_any   = {
            ...
            class    = {
                'scrcpy', 'Mugshot', 'Pulseeffects', 'Arandr', 'Gpick',
                'Kruler', 'Sxiv', 'Tor Browser', 'Wpa_gui', 'veromix', 'xtightvncviewer',
                "Blueberry", "Galculator", "Gnome-font-viewer", "Imagewriter", "Font-manager",
                "MessageWin", "Oblogout", "Peek", "Skype", "System-config-printer.py",
                "Unetbootin.elf", "pinentry", "xfce4-notes", "Xfce4-notes"
            },
            name     = { 'Event Tester' },
...
client.connect_signal('property::class', function(c)
    if c.class == 'Spotify' then
        ...
        for c2 in awful.client.iterate(function(c3) return ruled.client.match(c3, { class = 'Spotify' }) end) do
