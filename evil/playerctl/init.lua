...
play_button:buttons({ awful.button({}, 1, nil, function() playerctl:play_pause() end) })
next_button:buttons({ awful.button({}, 1, nil, function() playerctl:next() end) })
prev_button:buttons({ awful.button({}, 1, nil, function() playerctl:previous() end) })
