...
return function(s)
    ...
    widget_button:buttons({
        awful.button({}, 1, nil, function() awesome.emit_signal('widgets::control_center:toggle') end),
        awful.button({}, 3, nil, function() awesome.emit_signal('widgets::info_center:toggle') end)
    })
