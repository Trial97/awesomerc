...
return function(s, format)
  if not clock_widget then
    ...
    clock_widget = wibox.widget.textclock('<span font="Inter Bold 11">' .. clock_format .. "</span>", 1)
  end
  ...
  clockw:connect_signal("button::press", function(self, lx, ly, button)
  ...
  month_calendar:attach(clockw, "tc", { on_pressed = true, on_hover = false })
